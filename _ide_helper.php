 ...
 * Generated for Laravel 5.1.22 (LTS) on 2015-11-13.
 *
...
namespace {
    ...
    class ImageManager extends \Anakadote\ImageManager\Facades\ImageManager{
         ...
         * @static 
         */
        public static function getImagePath($file, $width, $height, $mode, $quality = 90){
            return \Anakadote\ImageManager\ImageManager::getImagePath($file, $width, $height, $mode, $quality);
        }
         ...
         * @static 
         */
        public static function getPath($from_root = false){
            return \Anakadote\ImageManager\ImageManager::getPath($from_root);
        }
        ...
        public static function getErrors(){
            return \Anakadote\ImageManager\ImageManager::getErrors();
        }
        ...
        public static function deleteImage($file){
            return \Anakadote\ImageManager\ImageManager::deleteImage($file);
        }
