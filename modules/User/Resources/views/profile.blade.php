                ...
                <div class="userTopInfoWraper">
                    <div class="avatarWarper">
                        ...
                        <div class="subAvatarMenuWraper">
                            <ul id="">
                                <a class="subAvatarMenuLink" href="#1">
                    ...
                    <div class="userPageRightInfCol">
                        ...
                        <div class="profileInfo">
                            <div class="profileInfoLeftCol"><p>День рождения:</p></div>
                            <div class="profileInfoRightCol"><p>{{ $account->getBirthDate() }}</p></div>
                            <div class="profileInfoLeftCol"><p>Родной город:</p></div>
                            <div class="profileInfoRightCol"><a href="#">{{ $account->city }}</a></div>
                            <div class="profileInfoLeftCol"><p>Семейное положение:</p></div>
                            <div class="profileInfoRightCol"><a href="#">{{ $account->getUserRelationship() }}</a></div>
                        </div>
